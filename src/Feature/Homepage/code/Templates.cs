...
namespace OneSound.Feature.Homepage
{
  public static class Templates
  {
    ...
    public static class HomepageHero
    {
      public static class Fields
      {
        public static readonly ID HomepageHeroSlide1BackgroundImage = new ID("{372D4EEF-4FE2-4040-B52B-28ED912AB099}");
        public static readonly ID HomepageHeroSlide1Title = new ID("{2B780F4A-E72B-44BC-ABD4-683532B83DDD}");
        public static readonly ID HomepageHeroSlide1Tagline = new ID("{A2C27361-C25E-4BFB-95AE-5C831455C06B}");
        public static readonly ID HomepageHeroSlide1CTALink = new ID("{48B24967-7AE3-48BE-BC6E-D2415D4797FF}");
        public static readonly ID HomepageHeroSlide1CTALinkText = new ID("{D6B08588-FFBB-400D-BC84-854D48432AE9}");

        public static readonly ID HomepageHeroSlide2BackgroundImage = new ID("{A99BC4F9-7A00-4B72-B9EE-04CB74CCACED}");
        public static readonly ID HomepageHeroSlide2Title = new ID("{CFAD1589-35EF-47E1-940C-F04D1BC00ED9}");
        public static readonly ID HomepageHeroSlide2Tagline = new ID("{801F3C13-29F2-41DA-946F-C15D672B9EB3}");
        public static readonly ID HomepageHeroSlide2CTALink = new ID("{98E015F2-69C5-42C7-9A21-2BE8C677E848}");
        public static readonly ID HomepageHeroSlide2CTALinkText = new ID("{73255306-BB94-4580-8C1E-6282E61E6E90}");
